...
class PDFROW extends FPDF
{
	...
	function SetFooterText($footer, $isUTF8 = true)
	{
		if ($isUTF8) {
	...
	function Row($data, $vpadding = 4, $fontStyle = '', $RowColors = array(), $fontsize = 0)
	{
		$this->SetX($this->TableX);
		if ($fontsize != 0){
	 ...
	 */
	function AddCol($field = -1, $width = -1, $caption = '', $align = 'L', $border = 0, $colColor = array())
	{
		if ($field == -1) {
	...
	function BeginTable($prop = array())
	{
	...
	function Texte($w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', $fill = false, $link = '')
	{
		$this->SetFont("", "");
		$this->Cell($w, $h, iconv('UTF-8', 'windows-1252', $txt), $border, $ln, $align, $fill, $link);
	}
	function Valeur($w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', $fill = false, $link = '')
	{
		$this->SetFont("", "B");
		$this->Cell($w, $h, iconv('UTF-8', 'windows-1252', $txt), $border, $ln, $align, $fill, $link);
	}
